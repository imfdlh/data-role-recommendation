import scrapy
from data_scientist.items import DataScientistItem

class ReviewspiderSpider(scrapy.Spider):
    
    name = 'reviewspiderMultiple'
    start_urls = ['https://id.indeed.com/lowongan-kerja?q=%2F+title%3A(data+scientist)&l=Indonesia&limit=50&lang=en']

    for i in range(50, 101, 50):
        start_urls.append('https://id.indeed.com/lowongan-kerja?q=%2F+title%3A(data+scientist)&l=Indonesia&limit=50&lang=en&start=' + str(i))
